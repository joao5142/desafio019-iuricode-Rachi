...
<ul>
	...
	<li>Execute a aplicação em modo de desenvolvimento(npm run serve)</li>
 	<li>Acesse http://localhost:8080(Ou outra porta caso a 8080 não esteja disponível) </li>
</ul>
...
<h4  style="display: inline_block">Visualização do site :</h4><a style="display: inline_block" target="blank" href="https://desafiorachi.netlify.app/">Preview no Netlify</a>
